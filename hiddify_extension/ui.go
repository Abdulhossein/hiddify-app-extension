...
func (e *HiddifyAppExtension) setFormData(data map[string]string) error {
...
func (e *HiddifyAppExtension) getRunningUI() ui.Form {

	return ui.Form{
		Title:       "hiddify-app-extension",
		Description: "Awesome Extension hiddify_app_extension created by Abdulhossein",
		Fields: [][]ui.FormField{
			{{
...
func (e *HiddifyAppExtension) getStoppedUI() ui.Form {
	// Inital page
	return ui.Form{
		Title:       "hiddify-app-extension",
		Description: "Awesome Extension hiddify_app_extension created by Abdulhossein",
...
func (e *HiddifyAppExtension) addAndUpdateConsole(message ...any) {
