...
func (e *HiddifyAppExtension) backgroundTask(ctx context.Context) {
...
func (e *HiddifyAppExtension) stop() error {
	if e.cancel != nil {
...
func NewHiddifyAppExtension() ex.Extension {
	return &HiddifyAppExtension{
		Base: ex.Base[HiddifyAppExtensionData]{
			Data: HiddifyAppExtensionData{ // Set default data
				Count: 4, // Default count value
			},
		},
		console: yellow.Sprint("Welcome to ") + green.Sprint("hiddify-app-extension\n"), // Default message
	}
}
...
func init() {
	ex.RegisterExtension(
		ex.ExtensionFactory{
			Id:          "github.com/Abdulhossein/hiddify_app_extension/hiddify_extension", // Package identifier
			Title:       "hiddify-app-extension",                                                         // Display title of the extension
			Description: "Awesome Extension hiddify_app_extension created by Abdulhossein",                                                     // Brief description of the extension
			Builder:     NewHiddifyAppExtension,                                                       // Function to create a new instance
		},
	)
}
